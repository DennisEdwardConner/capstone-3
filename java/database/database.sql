...
VALUES
    (1001,	'Thunder Island Brewing Company', '8',		'thunder-island.png', 	'a community-focused craft brewery committed to brewing distinctive beers while celebrating diversity, outdoor adventure, and all that the Gorge has to offer.', TRUE),
